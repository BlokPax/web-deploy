...
var require_command_exists = __commonJS({
  "node_modules/command-exists/lib/command-exists.js"(exports, module2) {
    ...
    var commandExistsUnix = function (
      commandName,
      cleanedCommandName,
      callback
    ) {
    ...
    var commandExistsWindows = function (
      commandName,
      cleanedCommandName,
      callback
    ) {
    ...
    var commandExistsWindowsSync = function (
      commandName,
      cleanedCommandName,
      callback
    ) {
...
async function run() {
  try {
    ...
    console.log(
      `\u{1F680} Thanks for using web deploy. Let's deploy some stuff!`
    );
    console.log(
      `----------------------------------------------------------------`
    );
    ...
    console.log(
      `or add a badge \u{1F3F7}\uFE0F to your projects readme --> https://github.com/SamKirkland/web-deploy#badge`
    );
    console.log(
      `----------------------------------------------------------------`
    );
...
function getUserArguments() {
  return {
    target_server: (0, import_core.getInput)("target-server", {
      required: true,
    }),
    ...
    private_ssh_key: (0, import_core.getInput)("private-ssh-key", {
      required: true,
    }),
